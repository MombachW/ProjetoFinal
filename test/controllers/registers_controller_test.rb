...
class RegistersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post registers_url, params: { register: { city: @register.city, cpf: @register.cpf, name: @register.name, number: @register.number } }
    end
  ...
  test "should update register" do
    patch register_url(@register), params: { register: { city: @register.city, cpf: @register.cpf, name: @register.name, number: @register.number } }
